...
Turn `browser_guard` from a Windows API prototype into a trustworthy, interview-ready open-source product that demonstrates practical C engineering.
...
- documentation suitable for users, contributors, and interview discussion.
...
- Add a concise interview demo script covering the problem, design, failure modes, trade-offs, tests, and measured results.
...
docs/interview-demo.md   Repeatable interview presentation and demonstration
...
10. An interviewer can follow `docs/interview-demo.md` to understand and demonstrate the project in 10–15 minutes.
...
8. Complete CI, open-source documentation, ADRs, and interview demo.
...
4. Is a 10–15 minute English interview demo the desired deliverable, or should the project include both English and Traditional Chinese presentation material?
